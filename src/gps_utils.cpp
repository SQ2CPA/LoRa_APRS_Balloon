...
namespace GPS_Utils
{
    ...
    {
        return TinyGPSPlus::distanceBetween(latitude, longitude, toLatitude, toLongitude) / 1000.0;
    }
    ...
    String decodeEncodedGPS(String packet)
    {
        ...
        String distance = String(calculateDistanceTo(decodedLatitude, decodedLongitude), 1);
    ...
    String getReceivedGPS(String packet)
    {
        ...
        String distance = String(calculateDistanceTo(convertedLatitude, convertedLongitude), 1);

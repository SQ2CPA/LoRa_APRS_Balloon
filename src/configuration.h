...
#define CONFIG_LORA_TX_ACTIVE // comment to disable
#define CONFIG_LORA_RX_ACTIVE // comment to disable

#define CONFIG_WSPR_ENABLE // comment to disable
...
// #define CONFIG_HISTORICAL_LOCATION_ENABLE // comment to disable
// #define CONFIG_CURRENT_DAY_ENABLE // comment to disable
